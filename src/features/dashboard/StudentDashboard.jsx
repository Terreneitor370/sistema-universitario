    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16 }}>
        <div style={{ ...card, height: 140, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          <div>
            <p style={{ fontSize: 32, fontWeight: 700, color: '#a4c9ff', lineHeight: 1 }}>8.47</p>
            <p style={{ fontSize: 11, color: '#4ade80', marginTop: 4 }}>≥ 8.0 requerido para titularse</p>
          </div>
        </div>
      </div>

      {/* Scholarship banner — shown only if GPA >= 9.5 */}
      <StudentScholarshipBanner gpa={8.47} />
